...
export declare function cleanAddress(address: EasyshipAddress): IDataObject;
export declare function getAddressValidationIssues(address: EasyshipAddress, prefix: 'sender' | 'recipient'): string[];
